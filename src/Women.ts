...
export const Women: Woman[] = [
  {
    ...
    bio: "Evelyn Boyd Granville was the second African-American woman to receive a Ph.D. in mathematics from an American university. She worked on various projects for the Apollo program, including celestial mechanics, trajectory computation, and 'digital computer techniques'.",
  },
  ...
  },
  {
    ...
    bio: "Eartha Mae Kitt was an American singer and actress known for her highly distinctive singing style and her 1953 recordings of 'C'est si bon' and the Christmas novelty song 'Santa Baby'. Kitt found a new generation of fans through her roles in the Disney films The Emperor's New Groove and Holes.",
  },
  {
    lastname: "Tallchief",
    quote:
